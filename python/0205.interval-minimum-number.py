...
class Solution:
    ...
    def intervalMinNumber(self, A, queries):
        self.segmentTree = [0 for i in range(len(A)*4)]
        if A :
    ...
    def buildSegmentTree(self,treeIndex,left,right,A) :
        ...
        self.segmentTree[treeIndex] = min(self.segmentTree[leftIndex],self.segmentTree[rightIndex])
    ...
    def query(self,treeIndex,treeLeft,treeRight,queryLeft,queryRight) :
        ...
        if queryLeft>mid :
            ...
            leftResult = self.query(leftIndex,treeLeft,mid,queryLeft,mid)
            rightResult = self.query(rightIndex,mid+1,treeRight,mid+1,queryRight)
